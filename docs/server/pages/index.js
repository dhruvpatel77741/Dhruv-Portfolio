(() => {
  ...
  (e.id = 405),
    ...
    (e.modules = {
      1860: (e, t, a) => {
        ...
        a.r(t),
          a.d(t, {
            ...
            reportWebVitals: () => T,
            routeModule: () => R,
            unstable_getServerProps: () => L,
            unstable_getServerSideProps: () => C,
            unstable_getStaticParams: () => N,
            unstable_getStaticPaths: () => I,
            unstable_getStaticProps: () => E,
          });
        var i = {};
        a.r(i),
          a.d(i, { default: () => Home, getStaticProps: () => getStaticProps });
        var o = a(7093),
          n = a(5244),
          s = a(1323),
          r = a(9209),
          ...
          m = a(3960);
        a(6689);
        let u = require('next/head');
        var h = a.n(u);
        let components_SEO = function () {
            return (0, d.jsxs)(h(), {
              children: [
                d.jsx('title', { children: m.hD.title }),
                d.jsx('meta', { name: 'title', content: m.hD.title }),
                d.jsx('meta', { name: 'author', content: m.hD.author }),
                d.jsx('meta', {
                  name: 'description',
                  content: m.hD.description,
                }),
                d.jsx('meta', {
                  name: 'keywords',
                  content: m.hD.keywords.join(', '),
                }),
                d.jsx('link', { rel: 'canonical', href: m.hD.url }),
                d.jsx('meta', { property: 'og:type', content: 'website' }),
                d.jsx('meta', { property: 'og:url', content: m.hD.url }),
                d.jsx('meta', { property: 'og:title', content: m.hD.title }),
                d.jsx('meta', {
                  property: 'og:description',
                  content: m.hD.description,
                }),
                d.jsx('meta', { property: 'og:image', content: m.hD.image }),
                d.jsx('meta', {
                ...
                d.jsx('meta', { property: 'twitter:url', content: m.hD.url }),
                d.jsx('meta', {
                ...
                d.jsx('meta', { name: 'robots', content: 'Index' }),
                d.jsx('link', { rel: 'manifest', href: '/manifest.json' }),
                d.jsx('link', {
          ...
          f = p()(() => a.e(808).then(a.bind(a, 7808)), {
            loadableGenerated: {
              modules: ['index.tsx -> ../components/Navigation'],
            },
          }),
          y = p()(
            () => Promise.all([a.e(289), a.e(771)]).then(a.bind(a, 4771)),
            {
              loadableGenerated: {
                modules: ['index.tsx -> ../containers/Greetings'],
              },
            }
          ),
          b = p()(() => a.e(874).then(a.bind(a, 2874)), {
            loadableGenerated: {
              modules: ['index.tsx -> ../containers/Skills'],
            },
          }),
          x = p()(() => a.e(250).then(a.bind(a, 3250)), {
            loadableGenerated: {
              modules: ['index.tsx -> ../containers/Proficiency'],
            },
          }),
          k = p()(() => a.e(942).then(a.bind(a, 2942)), {
            loadableGenerated: {
              modules: ['index.tsx -> ../containers/Education'],
            },
          }),
          S = p()(() => a.e(94).then(a.bind(a, 8094)), {
            loadableGenerated: {
              modules: ['index.tsx -> ../containers/Experience'],
            },
          }),
          v = p()(() => a.e(514).then(a.bind(a, 4514)), {
            loadableGenerated: {
              modules: ['index.tsx -> ../containers/Projects'],
            },
          }),
          P = p()(
            () => Promise.all([a.e(289), a.e(26)]).then(a.bind(a, 5026)),
            {
              loadableGenerated: {
                modules: ['index.tsx -> ../components/GithubProfileCard'],
              },
            }
          );
        function Home({ githubProfileData: e }) {
          return (0, d.jsxs)('div', {
            children: [
              d.jsx(components_SEO, {}),
              d.jsx(f, {}),
              d.jsx(y, {}),
              d.jsx(b, {}),
              d.jsx(x, {}),
        ...
        async function getStaticProps() {
          let e = await fetch(
            `https://api.github.com/users/${m.qL.githubUserName}`
          ).then((e) => e.json());
          return { props: { githubProfileData: e } };
        }
        let j = (0, s.l)(i, 'default'),
          D = (0, s.l)(i, 'getStaticProps'),
          w = (0, s.l)(i, 'getStaticPaths'),
          _ = (0, s.l)(i, 'getServerSideProps'),
          A = (0, s.l)(i, 'config'),
          T = (0, s.l)(i, 'reportWebVitals'),
          E = (0, s.l)(i, 'unstable_getStaticProps'),
          I = (0, s.l)(i, 'unstable_getStaticPaths'),
          N = (0, s.l)(i, 'unstable_getStaticParams'),
          L = (0, s.l)(i, 'unstable_getServerProps'),
          C = (0, s.l)(i, 'unstable_getServerSideProps'),
          R = new o.PagesRouteModule({
            definition: {
              kind: n.x.PAGES,
              page: '/index',
              pathname: '/',
      ...
      5913: (e, t, a) => {
        ...
        var i = a(997);
        a(9090), a(2762), a(2522), a(6230), a(3974);
      ...
      3960: (e, t, a) => {
        ...
        let i = require('react-easy-emoji');
        var o = a.n(i);
        let n = {
            name: 'Dhruv Patel',
          ...
          s = { githubUserName: 'dhruvpatel77741' },
          r = {
            url: '',
            ...
            data: [
              {
                ...
                skills: [
                  o()('⚡ Building RESTful APIs in NodeJs Framework'),
                  o()('⚡ Building responsive websites using React.js'),
                  o()(
              ...
              },
              {
                ...
                skills: [
                  o()('⚡ Experience of working on multiple cloud platforms'),
                  o()(
      ...
      1189: (e) => {
        'use strict';
        e.exports = require('react-lottie');
      },
      1665: (e) => {
        'use strict';
        e.exports = require('react-reveal/Fade');
      },
      997: (e) => {
        'use strict';
      ...
      6981: (e) => {
        'use strict';
        e.exports = require('reactstrap');
      },
      5566: (e) => {
        'use strict';
        e.exports = import('@iconify/react');
      },
      1017: (e) => {
        'use strict';
  ...
  var __webpack_exec__ = (e) => t((t.s = e)),
    a = t.X(0, [209, 221, 152], () => __webpack_exec__(1860));
  module.exports = a;
})();
